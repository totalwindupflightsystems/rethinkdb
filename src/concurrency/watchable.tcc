...
public:
    typedef typename std::invoke_result<callable_type, outer_type>::type result_type;
...
template<class value_type>
template<class callable_type>
clone_ptr_t<watchable_t<typename std::invoke_result<callable_type, value_type>::type> > watchable_t<value_type>::subview(const callable_type &lens) {
    assert_thread();
