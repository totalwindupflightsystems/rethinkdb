...
RDB_IMPL_SERIALIZABLE_5_SINCE_v2_4(time_chunk_bounds_t,
    min_time_us, max_time_us, row_count, root_block, merged);

RDB_IMPL_SERIALIZABLE_1_SINCE_v2_4(time_chunk_index_t, chunks);

RDB_IMPL_EQUALITY_COMPARABLE_5(time_chunk_bounds_t,
    min_time_us, max_time_us, row_count, root_block, merged);
